...
namespace ET
{
    public class Other2UnitCache_AddOrUpdateUnitHandler : AMActorRpcHandler<Scene,Other2UnitCache_AddOrUpateUnit,UnitCache2Other_AddOrUpdateUnit>
    {
        protected override async ETTask  Run(Scene scene,Other2UnitCache_AddOrUpateUnit request, UnitCache2Other_AddOrUpdateUnit response, Action reply)
        {
        ...
        private async ETTask UpdateUnitCacheAsync(Scene scene, Other2UnitCache_AddOrUpateUnit request, UnitCache2Other_AddOrUpdateUnit response)
        {
